...
CITY = "san_diego"  # Cidade para filtrar (usar _ no lugar de espaços)
PER_PAGE = 3        # Número de cervejarias por requisição
API_URL = f"https://api.openbrewerydb.org/v1/breweries?by_city={CITY}&per_page={PER_PAGE}"
...
def save_raw_data(data):
    ...
    filename = f"breweries_san_diego_{timestamp}.json"
...
def run_extraction():
    ...
    print(f"Iniciando extração de cervejarias em {CITY.replace('_', ' ')}...")
