...
COUNTRY = "south korea"  # País para filtrar
PER_PAGE = 3             # Número de cervejarias por requisição
API_URL = f"https://api.openbrewerydb.org/v1/breweries?by_country={COUNTRY.replace(' ', '%20')}&per_page={PER_PAGE}"
...
def save_raw_data(data):
    ...
    filename = f"breweries_korea_{timestamp}.json"
...
def run_extraction():
    ...
    print(f"Iniciando extração de cervejarias da {COUNTRY}...")
